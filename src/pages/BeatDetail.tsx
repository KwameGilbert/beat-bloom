...
const BeatDetail = () => {
  ...
  const producerBeats = allBeats
    .filter((b) => b.producer === beat.producer && b.id !== beat.id)
    .slice(0, 6);
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:px-8">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            {/* Cover Image */}
            <div className="group relative aspect-square w-full overflow-hidden rounded-2xl bg-zinc-900 shadow-2xl">
              <img
                src={beat.cover}
                alt={beat.title}
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 rounded-full bg-orange-500 px-6 py-3 font-bold text-white shadow-lg transition-all hover:bg-orange-600 active:scale-95"
              >
                {isLoadingCurrent ? (
                  <>
              ...
              <button className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/5 text-zinc-400 transition-colors hover:text-white">
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-4">
              ...
              <div className="flex gap-2">
                ...
                <button className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-3 text-sm font-bold text-white transition-all hover:bg-white/10">
