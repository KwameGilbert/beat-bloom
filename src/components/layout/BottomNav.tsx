...
export const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex h-16 items-center justify-around border-t border-white/10 bg-black/90 px-2 backdrop-blur-lg md:hidden">
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              isActive ? "text-orange-500" : "text-muted-foreground hover:text-white"
            )}
          >
